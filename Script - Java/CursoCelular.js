...
const modulos = [
    ...
    },
    {
        ...
        descricao: "Aprenda como fazer, atender e encerrar chamadas telefônicas, além de organizar sua agenda de contatos de forma simples.",
        imagem: "Imagens/Cursos/Celular/modulo2.png",
        importante: "Verifique sempre se está ligando para o número correto antes de discar.",
        dica: "Salve seus contatos com nomes fáceis de lembrar para não precisar digitar o número toda vez.",
        duracao: "6 minutos",
        nivel: "Iniciante",
        quiz: {
            pergunta: "Para não precisar digitar o número de um parente toda vez que quiser ligar, o que você deve fazer no seu celular?",
            opcoes: [
    ...
    {
        titulo: "Mensagens",
        descricao: "Descubra como enviar mensagens de texto e se comunicar com seus amigos e familiares rápida e com segurança.",
        imagem: "Imagens/Cursos/Celular/modulo3.png",
        importante: "Leia a mensagem com atenção antes de apertar o botão de enviar.",
        dica: "Você pode utilizar mensagens de voz caso ache mais fácil e rápido do que digitar.",
        duracao: "8 minutos",
        nivel: "Iniciante",
        quiz: {
            pergunta: "Sua mão está doendo para digitar um texto longo no teclado do celular. Qual recurso facilita esse envio?",
            opcoes: [
    ...
    },
    {
        ...
        descricao: "Aprenda a tirar fotos bonitas, gravar vídeos dos seus momentos especiais e visualizá-los na sua galeria.",
        imagem: "Imagens/Cursos/Celular/modulo4.png",
        importante: "Limpe a lente da câmera com um pano macio para as fotos não saírem embaçadas.",
        dica: "Segure o celular com as duas mãos para evitar que a foto saia tremida.",
        duracao: "10 minutos",
        nivel: "Iniciante",
        quiz: {
            pergunta: "As fotos que você tira no celular estão ficando embaçadas ou escuras. O que pode resolver isso antes de tirar a foto?",
            opcoes: [
    ...
    },
    {
        ...
        descricao: "Descubra como os aplicativos podem te ajudar no dia a dia, desde a previsão do tempo até alarmes e relógio.",
        imagem: "Imagens/Cursos/Celular/modulo5.png",
        importante: "Baixe e instale aplicativos apenas pela loja oficial do seu aparelho (Play Store ou App Store).",
        dica: "Peça ajuda a alguém de confiança se tiver dúvidas ao instalar um novo aplicativo.",
        duracao: "8 minutos",
        nivel: "Iniciante",
        quiz: {
            pergunta: "Você recebeu uma mensagem no celular sugerindo clicar em um link para baixar um novo aplicativo. Como proceder com segurança?",
            opcoes: [
    ...
    },
    {
        ...
        descricao: "Mantenha seu aparelho seguro, proteja suas senhas e aprenda a organizar seus aplicativos principais na tela inicial.",
        imagem: "Imagens/Cursos/Celular/modulo6.png",
        importante: "Nunca compartilhe suas senhas nem códigos recebidos por mensagem com desconhecidos.",
        dica: "Ajuste o brilho da tela e o tamanho da fonte nas configurações para ler com mais conforto.",
        duracao: "12 minutos",
        nivel: "Iniciante",
        quiz: {
            pergunta: "Uma pessoa ligou dizendo ser do seu banco e pediu um código que chegou no seu celular. O que você NUNCA deve fazer?",
            opcoes: [
...
const barraPreenchimento = document.querySelector(".barra-progresso-preenchimento");
const indicadorModuloTopo = document.querySelector(".progresso-texto span:first-child");
...
function carregarModulo(indice) {
    ...
    const opcoesQuiz = modulo.quiz.opcoes.map((opcao, i) => `
...
function configurarEventosQuiz(indiceModulo) {
    ...
    botoesOpcao.forEach(btn => {
        btn.onclick = () => {
            ...
            botoesOpcao.forEach(b => b.classList.remove("correta-selecionada", "errada-selecionada"));
...
function atualizarSidebar() {
    ...
    modulos.forEach((modulo, indice) => {
        ...
        let iconeStatus = '';
        if (progresso[indice]) {
            iconeStatus = '<i class="fa-solid fa-circle-check icone-status" style="color: var(--verde-principal);"></i>';
